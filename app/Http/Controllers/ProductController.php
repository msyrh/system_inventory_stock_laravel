...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')){
            ...
            $input['image'] = '/upload/products/'.$name.'.'.$request->image->getClientOriginalExtension();
    ...
    public function apiProducts(){
        ...
        return Datatables::of($product)
            ...
            ->addColumn('action', function($product){
                return '<a href="'.$product->image.'" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-eye-open"></i> Tampil</a> ' .
    ...
    public function exportpdf()
    {
        ...
        $pdf=PDF::loadview('product.productsallpdf',compact('products'));
