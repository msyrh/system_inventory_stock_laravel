...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><img src="{{asset('favicon_io/favicon-32x32.png')}}"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{asset('favicon_io/favicon-32x32.png')}}"><b>   Inventory</b>Stock</span>
        </a>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="https://github.com/msyrh">Company</a>.</strong> All rights reserved.
    </footer>
