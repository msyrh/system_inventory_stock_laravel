...
<div class="invoice-box">
    ...
    <table  width="80%" align="center">
        <tr>
            ...
            <td width="">: {{ $produkkeluars->id }}</td>
            <td width="30px">Dibuat</td>
            <td>: {{ $produkkeluars->tanggal }}</td>
        </tr>

        <tr>
            <td>Telepon</td>
            <td>: {{ $produkkeluars->customer->telepon }}</td>
            <td>Alamat</td>
            <td>: {{ $produkkeluars->customer->alamat }}</td>
        </tr>

        <tr>
            <td>Nama</td>
            <td>: {{ $produkkeluars->customer->nama }}</td>
            <td>Email</td>
            <td>: {{ $produkkeluars->customer->email }}</td>
        </tr>
    ...
    <table border="0" id="table-data" width="80%" align="center">
        ...
        <tr>
            <td>1</td>
            <td>{{ $produkkeluars->product->nama }}</td>
            <td>{{ $produkkeluars->qty }}</td>
            <td>{{ $produkkeluars->product->harga }} </td>
            <td>{{ $produkkeluars->total }}</td>
        </tr>
        <tr>
